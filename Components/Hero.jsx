    ...
    <div className="relative">
      ...
      <div className="relative bg-opacity-75 backgroundMain">
        ...
        >
          <path
            fill="currentColor"
            d="M-164 13L-104 39.7C-44 66 76 120 196 1410316 162 436 152 556 119.70676 88 796 34 916 1301036 -8 1156 2 1216 7.7L1276 13V162.5H1216C1156 162.5 1036 162.5 916 162.5C796 162.5 676 162.5 556 162.5C436 162.5 316 162.5 196 162.5C76 162.5 -44 162.5 -104 162.5H-164V13Z"
          />
        </svg>
          ...
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:pr-16 xl:mb-0 xl:w-7/12">
              <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-5xl sm:leading-none">
                Avnee and Vasvi <br className="hidden md:block" />
                Crowd Funding
              </h2>
              ...
              >
                ...
                <svg
                  ...
                  viewBox="0 0 12 12"
                >
                  <path d="M9.707,5.2931-5-501,1,0,0,0,3.293,1.70717.586,6,3.293,10. 293a1,1,0,1,0,1.414,1.41415-501,1,0,0,0,9.707,5.293Z" />
                </svg>
              </a>
            </div>
              ...
              <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                ...
                <form>
                  ...
                  <p className="text-xs text-gray-600 sm:text-sm">
                    By creating a campaign you agree to the terms of service.
                  </p>
                </form>
              </div>
            </div>
